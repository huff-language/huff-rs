...
fn instantiates() {
    ...
    assert_eq!(lexer.current_span().deref(), &Span::default());
    assert!(!lexer.eof);
}
...
fn single_line_comments() {
    ...
    assert_eq!(lexer.current_span().deref(), &Span::new(0..20, None));
    ...
    assert_eq!(lexer.current_span().deref(), &open_paren_span);
    ...
    assert_eq!(lexer.current_span().deref(), &close_paren_span);
...
fn multi_line_comments() {
    ...
    assert_eq!(lexer.current_span().deref(), &Span::new(0..21, None));
