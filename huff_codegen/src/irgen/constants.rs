use huff_utils::prelude::{CodegenError, Contract, CodegenErrorKind, bytes32_to_string, ConstVal, AstSpan};

/// Transforms a constant definition into it's respective bytecode
pub fn constant_gen(name: &str, contract: &Contract, ir_byte_span: AstSpan) -> Result<String, CodegenError> {
